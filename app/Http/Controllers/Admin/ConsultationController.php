...
class ConsultationController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function new(Request $request){
        ...
        $dataType = Voyager::model('DataType')->where('slug', '=', 'consultations')->first();
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $query = $model::select($dataType->name.'.*')->where('status','submitted')->whereNull('admin_rejected_at')->whereNull('admin_approved_at');
        ...
        // dd($dataType);
        return view('admin.consultations.new',compact(
        'dataType',
        'dataTypeContent',
        'isModelTranslatable',
        'search',
    ...
    public function assigned(Request $request){
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $query = $model::select($dataType->name.'.*')->where('status','assigned')->whereNull('admin_rejected_at')->whereNotNull('admin_approved_at')->whereNotNull('consultant_id');
        ...
        // dd($dataType);
        return view('admin.consultations.assigned',compact(
        'dataType',
        'dataTypeContent',
        'isModelTranslatable',
        'search',
    ...
    public function closed(Request $request){
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $query = $model::select($dataType->name.'.*')->where('status','closed');
        ...
        // dd($dataType);
        return view('admin.consultations.closed',compact(
        'dataType',
        'dataTypeContent',
        'isModelTranslatable',
        'search',
    ...
    public function rejected(Request $request){
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $query = $model::select($dataType->name.'.*')->where('status','rejected');
        ...
        // dd($dataType);
        return view('admin.consultations.rejected',compact(
        'dataType',
        'dataTypeContent',
        'isModelTranslatable',
        'search',
    ...
    public function consultants(Consultation $consultation,Request $request){
        // GET THE SLUG, ex. 'posts', 'pages', etc.

        // GET THE DataType based on the slug
        $dataType = Voyager::model('DataType')->where('slug', '=', 'consultants')->first();
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $query = $model::select($dataType->name.'.*')->where(function($q) use($consultation){
                $q->where('category_id',$consultation->category_id)->orWhere('category_id',null);
            });
        ...
        // dd($dataType);
        return view('admin.consultations.consultants',compact(
        'consultation',
        'dataType',
        'dataTypeContent',
        'isModelTranslatable',
    ...
    public function assignConsultant(Consultation $consultation,$consultants_id){
        ...
        $consultant->update([
            'consultations_no' => $consultant->consultations_no + 1,
        ]);
    ...
    public function manage(Consultation $consultation){
        return view('admin.consultations.manage',compact('consultation'));
    ...
    public function approveReply($id){
        ...
        $consultation = $reply->consultation;
        $reply->update([
            'status'=>'approved'
        ]);

        $consultation->user->notify(new ConsultationReplied($consultation));
