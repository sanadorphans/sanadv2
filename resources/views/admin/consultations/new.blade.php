                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            ...
                                            <a href="{{ route('admin.consultations.consultants',$data->id)}}" title="تعديل" class="btn btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> 
                                                <span class="hidden-xs hidden-sm">تعيين مستشار</span>
                                            </a>
                                            <button type="button" title="رفض" class="btn btn-sm btn-danger pull-right id_{{ $data->id }}" style="margin:5px 5px 5px 0;" id="reject_btn">
                                                {{-- <i class="voyager-x"></i>  --}}
                                                رفض
                                            </button>
            ...
            <form action="{{ route('admin.consultations.reject') }}" id="reject_form" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="reject_body">
                        ...
                        <input type="text" class="form-control" placeholder="تعليق" id="rejection_comment" name="comment">
                    </div>
                    <div class="modal-footer">
