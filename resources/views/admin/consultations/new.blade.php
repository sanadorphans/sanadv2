                                ...
                                <div id="search-input">
                                    ...
                                    <div class="col-2">
                                        <select id="filter" name="filter">
                                            <option value="contains" @if ($search->filter == 'contains') selected @endif>يحتوي
                                            </option>
                                    ...
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                                    ...
                                                    @elseif($row->field == 'attachment')
                                                        <td>
                                                            <a href="{{ $data->attachment }}"
                                                                target="_blank">{{ __('site.download') }}</a>
                                                        </td>
                                                    @else
                                                        <td>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                ...
                                                <a href="{{ route('admin.consultations.consultants', $data->id) }}"
                                                    title="تعديل" class="btn btn-sm btn-primary pull-right edit">
                                                    <i class="voyager-edit"></i>
                                                    <span class="hidden-xs hidden-sm">تعيين مستشار</span>
                                                </a>
                                                <button type="button" title="رفض"
                                                    class="btn btn-sm btn-danger pull-right id_{{ $data->id }}"
                                                    style="margin:5px 5px 5px 0;" id="reject_btn">
                                                    {{-- <i class="voyager-x"></i>  --}}
                                                    رفض
                                                </button>
            ...
            <form action="{{ route('admin.consultations.reject') }}" id="reject_form" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="reject_body">
                        ...
                        <input type="text" class="form-control" placeholder="تعليق" id="rejection_comment"
                            name="comment">
                    </div>
                    <div class="modal-footer">

                        <button id="reject_form_button" type="submit" class="btn btn-danger pull-right delete-confirm"
                            value="نعم" style="margin: 0 5px;">نعم</button>
...
@section('javascript')
    ...
    <script>
        window.onload = function() {
            ...
            var rejection_id = $('#rejection_id');
            var comment = $('#rejection_comment');
            var reject_id = '';
            ...
            //     console.log($rejection_id.val());
            // });
            // $('#reject_form_button').on('click',function(e){
            //     e.preventDefault();
            //     console.log(reject_id);
            //     $rejection_id.val(reject_id);
            //     $("#reject_form").attr("action", ($("#reject_form").attr("action")+reject_id));
            //     $('#reject_form').submit();
            // })
        }
    </script>
