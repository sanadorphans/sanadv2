                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                ...
                                                @if($row->field == 'status')
                                                    <td >
                                                        ...
                                                        @elseif($data->status == 'rejected')
                                                            <span
                                                                class="badge badge-pill badge-danger">{{ __('site.' . $data->status) }}</span>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            ...
                                            {{-- <button  title="رفض" class="btn btn-sm btn-danger pull-right id_{{ $data->id }}" style="margin:5px 5px 5px 0;" id="reject_btn">
                                                <i class="voyager-x"></i>
                                                رفض
                                            </button> --}}
