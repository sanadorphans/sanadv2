                            ...
                            <tr>
                                ...
                                <td style="width: 20%">
                                    ...
                                    @elseif($consultation->status == 'assigned')
                                      @if ($consultation->replies()->where('consultation_replies.owner',0)->where('consultation_replies.status','approved')->count())
                                      <span
                                          class="badge badge-pill badge-warning">{{ __('site.ongoing') }}
                                      </span>
                                      @else
                                      <span
                                ...
                                <td style="width: 20%">
                                  <div>
                                      ...
                                      <a href="{{ url('users/consultation/chat/'.$consultation->id) }}" class="btn btn-orange" style="padding:5px 10px !important">
                                              {{ __('site.details') }}
                                      </a>
                                      @if ($consultation->status == 'assigned')
                                          <a href="{{ url('users/consultation/main/status/' . $consultation->id) }}" class="btn btn-red" style="padding:5px 10px !important">
                                                  {{ __('site.close') }}
                                          </a>
