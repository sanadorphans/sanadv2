...
@section('content')
    ...
    <section id="service">
        ...
        @if($sub_service->id == 37)
                <button style="color:#fff;background:#35C0CA;width:15%;"> <a href="https://forms.office.com/pages/responsepage.aspx?id=g11yLv_fmkufB2_5vZQDnYt-qNTHUTtCj-DLbk9A77NURElBTjhCT0JJRjA4VjVHTUhLSUFUNkpIWS4u&route=shorturl">{{ __('lang.Apply') }}</a></button>
        @else
                <button style="color:#fff;background:#35C0CA;width:15%;"> <a href="https://forms.cloud.microsoft/r/JVGxFj8WXK">{{ __('lang.Apply') }}</a></button>
        @endif
        </div>
    </section>
    <div class="slider">
